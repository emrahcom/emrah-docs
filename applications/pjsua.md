...
- `--tls-verify-client` and `--tls-verify-server` are not needed if the
  certificates are trusted or if the certificates are generated by CA
  certificate provided by `--tls-ca-file`.
